...
/*
  CategoryBrand
*/
export const createCategoryBrand = createAsyncThunk(
  "category/createCategoryBrand",
  async ({ brandId, categoryId }) => {
    try {
      const response = await authRequest.post(
        "api/category/" + categoryId + "/brand/create/" + brandId,
      );
      return response.data;
    } catch (err) {
      return Promise.reject(err.message);
...
export const deleteCategoryBrand = createAsyncThunk(
  "category/deleteCategoryBrand",
  async ({ brandId, categoryId }) => {
    try {
      const response = await authRequest.delete(
        "api/category/" + categoryId + "/brand/delete/" + brandId,
      );
      return response.data;
    } catch (err) {
      return Promise.reject(err.message);
