...
export const toggleFavouriteProduct = createAsyncThunk("basket/toggleFavourite", async (productId) => {
    try {
...
export const appendProduct = createAsyncThunk("basket/appendProduct", async ({ productId, quantity }) => {
    try {
...
export const incrementProduct = createAsyncThunk("basket/incrementProduct", async ({ productId, quantity }) => {
    try {
...
export const decrementProduct = createAsyncThunk("basket/decrementProduct", async ({ productId, quantity }) => {
    try {
...
export const removeProductFromBasket = createAsyncThunk("basket/removeProduct", async (productId) => {
    try {
