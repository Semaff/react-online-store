...
const AdminBlock = ({ title, children }) => {
  ...
  return (
    <div className="admin__block">
      ...
      <div
        className="admin__block-content"
...
const AdminList = ({ setView, setVisible, name, withoutUpdate }) => {
  return (
    <ul className="admin__list">
      <li>
        <button
          className="btn --poppins --black --small"
          onClick={() => {
            setView("create");
            setVisible(true);
          }}
...
const Admin = () => {
  ...
  return (
    <>
      ...
      <CategoryBrandModal
        show={categoryBrandVisible}
        setShow={setCategoryBrandVisible}
        view={categoryBrandView}
      />
      <ProductModal show={productVisible} setShow={setProductVisible} view={productView} />
      <TestimonialModal
        show={testimonailVisible}
        setShow={setTestimonialVisible}
        view={testimonailView}
      />
          ...
          <div className="admin">
            ...
            <div className="admin__control">
              ...
              <AdminBlock title="Brand">
                <AdminList setView={setBrandView} setVisible={setBrandVisible} name="Brand" />
              </AdminBlock>
              ...
              <AdminBlock title="Product">
                <AdminList setView={setProductView} setVisible={setProductVisible} name="Product" />
              </AdminBlock>
