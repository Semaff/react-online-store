...
const About = ({ isMini }) => {
  return (
    <div
      className={`about ${isMini ? "--mini" : ""}`}
      style={!isMini ? { backgroundImage: "url('./images/about-bg.jpg')" } : null}
    >
      <div className="about__item">
        <img
          src={isMini ? `./images/about-3.jpg` : `./images/about-2.jpg`}
          alt="1"
      ...
      <div className="about__item  --reversed">
        ...
        <img
          src={isMini ? `./images/about-4.jpg` : `./images/about-1.jpg`}
          alt="2"
          className="about__img"
        />
      </div>
